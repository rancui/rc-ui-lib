...
const Dialog: React.FC<DialogProps> = (props) => {
  ...
  const handleLoadingStatus = (action: string, status: boolean) => {
    ...
    if (action === 'confirm') {
      setLoadingConfirm(status);
    } else {
      setLoadingCancel(status);
    }
  };
      ...
      <ActionBar className={classnames(`${baseClass}__footer`)}>
        {showCancelButton && (
          <Button
            ...
            type="warning"
            text={cancelButtonText}
            className={classnames(`${baseClass}__cancel`, `${baseClass}__cancel__space-around`)}
            round
        ...
        {showConfirmButton && (
          <Button
            ...
            text={confirmButtonText}
            round
            className={classnames(`${baseClass}__confirm`, `${baseClass}__confirm__space-around`)}
