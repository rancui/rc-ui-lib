...
const PickerColumnComponent = forwardRef<PickerColumnExpose, PickerColumnProps>((props, ref) => {
  ...
  const optionsRef = useRef<PickerOption[]>(deepClone(initialOptions) as unknown as PickerOption[]);
...
const PickerColumn = memo(PickerColumnComponent, (prev, next) => {
